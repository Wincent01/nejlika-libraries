#include "BSPackedAdditionalGeometryData.hpp"

using namespace nejlika::geometry;

void BSPackedAdditionalGeometryData::Read(nejlika::Reader& reader, uint32_t version, uint32_t user, uint32_t arg)
{
...
void BSPackedAdditionalGeometryData::Write(nejlika::Writer& writer, uint32_t version, uint32_t user, uint32_t arg) const
{
