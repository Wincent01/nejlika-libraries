...
void MTransform::Read(nejlika::Reader& reader, uint32_t version, uint32_t user, uint32_t arg)
{
...
void MTransform::Write(nejlika::Writer& writer, uint32_t version, uint32_t user, uint32_t arg) const
{
